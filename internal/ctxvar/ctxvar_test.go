...
func TestUrlStandardValues(t *testing.T) {
	...
	assert.Equal(t, "/teams/team-slug/schedule/tournament-slug/players/player-slug/games/game-slug/events/5/url", Url(ctx, Team, Tournament, Player, Game, Event, "url"))
